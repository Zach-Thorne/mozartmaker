...
#Function which matches images to one another then returns an array of the image locations 
...
if __name__ == "__main__":
    ...
    for box in staff_boxes:
        ...
        note_group = []
        i = 0; j = 0;
        print( "Staff note lengths %d, and staffs length %d" % (len(staff_notes), len(staffs)))
